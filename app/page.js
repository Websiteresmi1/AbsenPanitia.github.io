      ...
      <header className="relative z-10 border-b border-white/10 bg-slate-900/60 backdrop-blur-md sticky top-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2.5 sm:gap-4">
            ...
            <div className="hidden md:flex flex-col text-right" suppressHydrationWarning>
            ...
            <button
              ...
              className="p-2 sm:px-3 sm:py-2 text-xs font-medium rounded-lg bg-white/5 hover:bg-white/10 text-slate-300 hover:text-white border border-white/10 transition-all flex items-center gap-1.5 active:scale-95"
            >
              <RefreshCw
            ...
            <Link
              href="/login"
              className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-xs sm:text-sm font-semibold shadow-md shadow-emerald-900/30 transition-all active:scale-95 ring-1 ring-white/20"
            >
